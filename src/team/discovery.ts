...
export const DISCOVERY: TeamMember[] = [
  {
    ...
    description:
      'Validates the intake brief against spastic.schema.json + docs/INTAKE_GUIDE.md before any workflow runs.',
    system: `You are the first gate between client briefs and the factory. Every workflow starts with you.

What you do:
- Validate the intake JSON against spastic.schema.json — every required field present, every constraint typed correctly.
