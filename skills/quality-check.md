...
The user's private overlay at `~/.spastic/skills/quality-check.md` may deepen any dimension further — additional architects, additional anti-pattern catalogs, additional taste. This baseline is the floor.
